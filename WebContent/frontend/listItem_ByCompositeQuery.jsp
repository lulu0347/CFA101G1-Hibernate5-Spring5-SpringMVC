			...
			<div style="margin-top: 56px">
				<div class="container">
					...
					<div class="row">
						<div class="col-3">
							<a href="#page-top"> <img
								src="<%=request.getContextPath()%>/frontend/auctAct/images/logo.jpg"
						...
						<div class="col-6">
							...
							<div class="row align-items-end" style="height: 80px;">
								...
								<div class="col">
									<a
										href="<%=request.getContextPath()%>/frontend/used/listAllProd.jsp">
								...
								<div class="col">
									<a
										href="<%=request.getContextPath()%>/frontend/bid/listAllBid.html">
									...
									<div class="card" style="width: 18rem;">
										...
										<div class="card-body">
											...
											<form name="shoppingForm"
												...
												<input type="hidden" name="action" value="getOneItemForView"><input
													type="hidden" name="action" value="getOneItemForView">
												<input class="btn btn-primary" type="submit" name="Submit"
													value="查看商品詳情">
											</form>
											<c:if test="${user.memno != null}">

												<c:set var="checkcount" scope="page"
													value="${itemCollectionSvc.getcount(itemVO.itemNo,user.memno)}" />
												<c:choose>
													<c:when test="${checkcount <= 0}">
														<a id="collection-a"
															href="<%=request.getContextPath()%>/itemCollection/itemCollection.do?action=addCollection&memNo=${user.memno}&itemNo=${itemVO.itemNo}">
															<img id="collection-img"
															src="<%=request.getContextPath()%>/resource/Images/uncollect.png"
															width="50" height="50">
														</a>
													</c:when>
													<c:when test="${checkcount > 0}">
														<a id="collection-a"
															href="<%=request.getContextPath()%>/itemCollection/itemCollection.do?action=addCollection&memNo=${user.memno}&itemNo=${itemVO.itemNo}">
															<img id="collection-img"
															src="<%=request.getContextPath()%>/resource/Images/collected.png"
															width="50" height="50">
														</a>
													</c:when>
												</c:choose>
