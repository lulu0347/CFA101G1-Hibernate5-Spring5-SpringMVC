				...
				<div class="divforp">
                    ...
                    <span>  
                            ...
                            <c:forEach var="itemPicVO" items="<%= itemPicSvc.getAllPics() %>">
                                <c:if test="${itemICVO.itemNo==itemPicVO.itemVO.itemNo}">
                                    <img class="img-fluid" src="<%=request.getContextPath()%>/showItemPic?itemPicNo=${itemPicVO.itemPicNo}">
                                </c:if>  
                            </c:forEach>  
                            </div>
                   ...
                   <div class="div7">
                       ...
                       <span class="span2">
                       		<button id="bt1" type="button" class="btn btn-secondary" onclick="location.href='<%=request.getContextPath()%>/getOneItemForViewFromListAllCollection?itemNo=${itemICVO.itemNo}'">點我購買</button>
                       		<button id="bt1" type="button" class="btn btn-danger" onclick="location.href='<%=request.getContextPath()%>/deleteCollection?itemNo=${itemICVO.itemNo}&memNo=${user.memNo}'">取消此收藏</button>
                       </span>
                   </div> 
                </c:forEach> 
				</div>
