		...
		<div class="prod" style="width: 100%;">
			<div class="row">
				<div class="col-3">
					<div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
						...
						<ul class="nav nav-pills flex-column mb-auto ">
							...
							<li><a href="<%=request.getContextPath()%>/frontend/bid/order_Index5.jsp" class="nav-link link-dark" style="background-color: #69d0f5"> <i
									class=""> &nbsp;</i>查詢已收貨的訂單</i>
							</a></li>
				...
				<div class="col-9" id="showPanel">
					...
					<%@ include file="order_tabs/listAllBidOrder_ByBidWinnerNo4.jsp" %>
