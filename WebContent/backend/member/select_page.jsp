  ...
  <li>
	  ...
	  <div class="card">
	    ...
	    <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
	      <div class="card-body">
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/enterMemNoToFindOneMember" >
		        <b>輸入會員編號 (如11001):</b>
		        <input type="text" name="memno">
		        <input type="hidden" name="action" value="enterMemNoToFindOneMember">
	      ...
	      <div class="card-body" >
			...
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/selectMemNoToFindOneMember" >
		       <b>選擇會員編號:</b>
		       ...
		       <input type="hidden" name="action" value="selectMemNoToFindOneMember">
		       <input type="submit" value="送出">
		    </FORM> 	      	
	      </div>
	      <div class="card-body">
		     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/selectMemNameToFindOneMember" >
		       <b>選擇會員姓名:</b>
		       <select size="1" name="memno">
		         <c:forEach var="memVO" items="${memSvc.all}" > 
		       ...
		       <input type="hidden" name="action" value="selectMemNameToFindOneMember">
		       <input type="submit" value="送出">
		     </FORM>	      	
	      </div>
	    </div>
