...
<%
	...
	List<ItemPicVO> list = itemPicSvc.getAllPics();
		...
		<c:forEach var="itemPicVO" items="${list}">
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="div3">商品編號 : ${itemPicVO.itemVO.itemNo}</div>
					<div class="div4">
						...
						'<%=request.getContextPath()%>/findByItemPicNoToUpdate?itemPicNo=${itemPicVO.itemPicNo}'">
							修改商品照片</button>
							
							<button id="bt2" type="button" class="btn btn-danger"
							onclick="location.href=
						'<%=request.getContextPath()%>/deletePic?itemPicNo=${itemPicVO.itemPicNo}'">
							刪除商品照片</button>
					</div>
				</div>
