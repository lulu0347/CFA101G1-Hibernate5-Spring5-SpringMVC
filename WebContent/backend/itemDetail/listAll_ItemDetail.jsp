...
<header>
  ...
  <c:forEach var="itemDetailVO" items="${list}">
      ...
      <div class="col-4">
        一般商城訂單編號 : ${itemDetailVO.id.orderNo}
      </div>
      <div class="col-8"></div>
    </div>
    <div class="row" id="row2">
      <div class="col-4">
        商品編號 : ${itemDetailVO.id.itemNo}
      </div>
      <div class="col-4">
        商品名稱 : ${itemSvc.getOneItem(itemDetailVO.id.itemNo).itemName}
      </div>
      <div class="col-4"></div>
    </div>
    <div class="row" id="row3">
      <div class="col-4">
        商品銷量 : 共 ${itemDetailVO.itemSales} 個
      </div>
      <div class="col-4">
        商品單價 : $ ${itemDetailVO.itemPrice}
      </div>
      <div class="col-4"></div>
    </div>
