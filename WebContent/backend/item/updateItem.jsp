		...
		<div class="prod" style="width: 100%;">
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="col-2">
						<button id="bt2" type="button" class="btn btn-primary" onclick="location.href='<%=request.getContextPath()%>/item/item.do?action=getOne_For_Update&itemNo=${itemVO.itemNo}'">修改商品</button>
					</div>
					<div class="col-8">
					</div>
				</div>
