			...
			<div class="row">
				...
				<div class="col-9" id="col-9-1">
					...
					<div class="div-3">
						...
						<span class="span2">
					<c:choose>
						<c:when test="${itemVO.productKindVO.kindNo == '1'}">
							
							商品分類: 手機
						
						</c:when>
						<c:when test="${itemVO.productKindVO.kindNo == '2'}">
			
							商品分類: 電腦
			
						</c:when>
						<c:when test="${itemVO.productKindVO.kindNo == '3'}">
			
							商品分類: 相機
			
						</c:when>
						<c:when test="${itemVO.productKindVO.kindNo == '4'}">
			
							商品分類: 手錶
			
						</c:when>
						<c:when test="${itemVO.productKindVO.kindNo == '5'}">
				...
				<div class="row">
					...
					<div class="col-2">
						...
						'<%=request.getContextPath()%>/getOneItemToUpdate?itemNo=${itemVO.itemNo}'">修改商品資料</button>
					</div>
					
					<div class="col-2">
					<button id="bt2" type="button" class="btn btn-danger" onclick="location.href=
						'<%=request.getContextPath()%>/deleteItem?itemNo=${itemVO.itemNo}'">刪除此商品</button>
					</div>
					<div class="col-6">
					</div>
				</div>
