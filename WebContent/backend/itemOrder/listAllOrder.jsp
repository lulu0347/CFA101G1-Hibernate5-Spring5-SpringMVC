...
<header>
  ...
  <c:forEach var="itemOrderVO" items="${list}">
        ...
        <div class="row" id="row1">
          <div class="col-3" >購買會員編號 : ${itemOrderVO.memberVO.memNo}</div>
        ...
        <div class="row">
					...
					<button id="bt2" type="button" class="btn btn-danger" onclick="location.href=
						'<%=request.getContextPath()%>/deleteOneOrder?orderNo=${itemOrderVO.orderNo}'">刪除此訂單</button>
					</div>
					
					<div class="col-2">
					<button id="bt2" type="button" class="btn btn-secondary" onclick="location.href=
						'<%=request.getContextPath()%>/itemIOD/itemIOD.do?action=admincancel&orderNo=${itemOrderVO.orderNo}'">取消此訂單</button>
					</div>
					<div class="col-2">
					<button id="bt2" type="button" class="btn btn-light" onclick="location.href=
						'<%=request.getContextPath()%>/itemIOD/itemIOD.do?action=adminShipped&orderNo=${itemOrderVO.orderNo}'">後台確認出貨</button>
					</div>
					<div class="col-4">
					</div>
		</div>
